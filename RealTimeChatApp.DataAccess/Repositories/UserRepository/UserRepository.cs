...
public class UserRepository : IUserRepository
{
    ...
    public async Task<bool> IsUserBlocked(int userId, int blockedUserId)
    {
        return _context.BlockedContacts.Any(bc => bc.UserId == userId && bc.BlockedUserId == blockedUserId);
    }
    ...
    {
        User user = _context.Users.Include(x => x.BlockedContacts).FirstOrDefault(x => x.Id == int.Parse(id));
        return user;
    }
